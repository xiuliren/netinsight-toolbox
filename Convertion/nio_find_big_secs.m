...
% 
% [ con_secs_idx tm_secs_idx ] = nio_find_big_secs( network, key_idx,
...
function [ con_secs_idx tm_secs_idx checked_secs_bin ] = nio_find_big_secs( network, key_idx, con_secs_idx, tm_secs_idx, checked_secs_bin, Td )
...
for k = 1 : length( new_secs_idx )
    [ con_secs_idx tm_secs_idx checked_secs_bin] = nio_find_big_secs( network, new_secs_idx(k), con_secs_idx, tm_secs_idx, checked_secs_bin, Td );
end